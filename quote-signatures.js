...
(function(){
  ...
  const install=()=>{
    ...
    s.textContent=`
      ...
      #quotePrint .tk-sign-box{min-height:170px;border:1px solid #dbe3ec;border-radius:16px;background:linear-gradient(180deg,#ffffff,#f8fafc);padding:17px 18px;position:relative;break-inside:avoid}
      ...
      #quotePrint .tk-sign-space{height:74px;margin-top:8px;border-bottom:1px dashed #cbd5e1;position:relative}
      ...
      #quotePrint .tk-stamp{position:absolute;right:18px;bottom:18px;width:88px;height:62px;border:2px dashed #94a3b8;border-radius:12px;display:flex;align-items:center;justify-content:center;text-align:center;font-size:9px;line-height:1.25;color:#64748b;font-weight:800;transform:rotate(-3deg);text-transform:uppercase}
  ...
  const add=()=>{
    ...
    section.innerHTML=`
      ...
      <div class="tk-sign-box">
        <div class="tk-sign-title">Firma Onayı</div>
        <div class="tk-sign-sub">Firma yetkilisi / kaşe</div>
        <div class="tk-sign-space"></div>
        <div class="tk-sign-name">Yetkili: ${esc(firmRep||'................................')}</div>
        <div class="tk-stamp">${esc(companyName)}<br>KAŞE</div>
      </div>`;
